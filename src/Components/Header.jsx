...
const Header = () => {
  return (
    <div className="flex items-center justify-center gap-8 flex-col" id="#home">
      <div className="flex items-center justify-center">
        <h1 className="font-coro font-normal text-6xl tracking-wide text-center">
          Antique NFT market
        </h1>
      </div>
      <div className="w-screen ">
        <HeaderSlider SliderImg={SliderImg} />
      </div>
    </div>
  );
};
